...
# ---- DEBUG: trace who prints TAIFEX BidAsk ----
...
def _trace_print(*args, **kwargs):
    try:
        ...
        if "Exchange.TAIFEX" in s and "BidAsk(" in s:
            _ORIG_PRINT("\n[PRINT-TRACE] Someone printed a TAIFEX BidAsk. Call stack:\n")
            _ORIG_PRINT("".join(traceback.format_stack(limit=12)))
    except Exception:
        pass
