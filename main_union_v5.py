    ...
    for i in range(0, len(candidates), chunk_size):
        ...
        for opt, ticker in tickers:
            ...
            results.append({
                ...
                "kelly": kelly,
                # store OI internally (not in file header unless you want)
                "open_interest": oi,
            })
...
def format_candidate_line(r: Dict, hv_val: float) -> str:
    ...
    # Symbol Expiry | DTE | Strike | Bid(Src) | Ret% | Ann% | Ideal | Ratio | Shp | IV | HV | Theta | Delta | Kelly% | IVR | T/D
    #
