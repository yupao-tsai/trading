...
class Reconciler:
    ...
    def reconcile(self):
        ...
        # update_status triggers callbacks
        try:
            print("  [Reconciler] update_status...")
            if hasattr(self.api, "update_status"):
                # some shioaji builds need account passed in
                try:
                    self.api.update_status(self.api.stock_account)
                except Exception:
                    pass
    ...
    def _fetch_snapshot_once(self) -> AccountSnapshot:
        ...
        try:
            ...
            for p in stk_pos:
                ...
                stock_positions[code] = stock_positions.get(code, 0) + qty * STOCK_SHARES_PER_LOT * sign
        except Exception:
            pass
