    ...
    try:
        ...
        if filtered.empty:
            ...
            for row in position_rows:
                ...
                row_str = f"{row['expiry']:<10} | {row['dte']:<4} | {strike_display:<8} | {price_disp:<12} | {row['qty']:<4} | {row['pl_str']:<7} | {row['ann']*100:<6.1f} | {row['ideal']:<8.2f} | {row['ratio']:<6.2f} | {row['sharpe']:<4.2f} | {row['iv']:.2f}*  | {row['delta']:>7.2f}* | {row['kelly']*100:>6.1f}%"
